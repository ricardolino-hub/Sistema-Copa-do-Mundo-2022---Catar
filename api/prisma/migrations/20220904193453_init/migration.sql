...
CREATE TABLE "Matchup_Team" (
    ...
    CONSTRAINT "Matchup_Team_id_matchup_team_fkey" FOREIGN KEY ("id_matchup_team") REFERENCES "Team" ("id_team") ON DELETE RESTRICT ON UPDATE CASCADE,
    CONSTRAINT "Matchup_Team_id_matchup_team_fkey" FOREIGN KEY ("id_matchup_team") REFERENCES "Matchup" ("id_matchup") ON DELETE RESTRICT ON UPDATE CASCADE
);
